                ...
                <div className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-16 ${isRTL ? "lg:flex-row-reverse" : ""}`}>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-5 justify-center lg:justify-start mb-12">
                            ...
                            >
                                ...
                                <div className="text-start border-s border-white/20 ps-4">
                                    ...
                                    <span className="block text-lg tracking-tight">{t("downloadCta")}</span>
                                </div>
                            </a>
                    ...
                    <div className="lg:w-2/5 w-full relative flex justify-center">
                        <div className="relative w-[260px] sm:w-[300px] md:w-[330px] mx-auto">
                            ...
                            {/* Floating Cards */}
                            <div className={`absolute top-12 hidden lg:flex items-center gap-3 bg-white/95 dark:bg-slate-800/95 backdrop-blur-md p-3.5 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 animate-pulse-slow z-20 ${isRTL ? "-left-16" : "-right-16"}`}>
                                <div className="size-10 rounded-2xl bg-gradient-to-br from-emerald-400 to-green-600 flex items-center justify-center">
                                    <Bell size={18} className="text-white" />
                                </div>
                                <div className="text-start">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase leading-none mb-1">{t("floatingCards.liveOrderLabel")}</p>
                                    <p className="text-sm font-black text-slate-900 dark:text-white leading-tight">{t("floatingCards.liveOrderText")}</p>
                                </div>
                            </div>

                            <div className={`absolute bottom-24 hidden lg:flex items-center gap-3 bg-white/95 dark:bg-slate-800/95 backdrop-blur-md p-3.5 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 animate-pulse-slow [animation-delay:1.5s] z-20 ${isRTL ? "-right-14" : "-left-14"}`}>
                                ...
                                <div className="text-start">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase leading-none mb-1">{t("floatingCards.responseLabel")}</p>
                                    <p className="text-sm font-black text-slate-900 dark:text-white leading-tight">0.2s <span className="text-emerald-500 text-xs">↗ 99%</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
