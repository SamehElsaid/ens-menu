...
export const templatesInfo: TemplateInfo[] = [
  {
    ...
    image: "/images/temp/default.jpeg",
    description:
  ...
  },
  {
    ...
    descriptionAr: "قالب قائمة قهوة بتصميم داكن أنيق وعرض احترافي للأصناف",
    isNew: false,
    canEdit: false,
    slug: "coffee",
  ...
  },
  {
    ...
    isNew: true,
    canEdit: true,
    descriptionAr: "قالب بألوان نيون متوهجة وتأثيرات بصرية عصرية تُبرز هوية مطعمك",
    slug: "neon",
...

  {
    ...
    descriptionAr: "قالب بتدرجات زرقاء مستوحاة من السماء وتصميم نظيف وواضح",
    isNew: true,
    canEdit: true,
    slug: "sky",
  ...
  
  {
    ...
    descriptionAr: "قالب ناعم بألوان دافئة وتصميم بسيط يناسب الكافيهات والحلويات",
    isNew: true,
    canEdit: true,
    slug: "vanilla",
    colors: ["#7B2CBF", "#5A189A"],
