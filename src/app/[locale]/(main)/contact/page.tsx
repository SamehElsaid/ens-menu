...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildSeoMetadata({
    ...
    description: resolveMetaField(dynamic, locale, "description", t("contactPage.description")),
    keywords: resolveMetaField(dynamic, locale, "keywords", t("contactPage.keywords")),
